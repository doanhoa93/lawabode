<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" action="<?php echo site_url('admin/galleries/edit')?>" method="post">
                <input type="hidden" name="id" value="<?php echo $gallery['id']?>">
                <div class="box-body">
                    <?php echo message_box(validation_errors(),'danger'); ?>
                    <div class="form-group">
                        <label for="post_title">Title</label>
                        <input type="text" name="title" class="form-control" id="post_title" placeholder="Title" value="<?php echo set_value('title', isset($gallery['title']) ? $gallery['title'] : '') ?>">
                    </div>
                    <div class="form-group">
                        <label for="post_status">Featured Image</label>
                        <input type="hidden" name="featured_image" value="<?php echo set_value('featured_image', isset($customer['featured_image']) ? $gallery['featured_image'] : '') ?>" id="featured_image">
