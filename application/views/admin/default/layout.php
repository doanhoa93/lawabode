...
<html>
    <head>
        ...
        <!-- jQuery 2.0.2 -->
        <script src="<?php echo $base_assets_url;?>js/jquery.min.js" type="text/javascript"></script>
        <!-- jQuery UI 1.10.3 -->
    ...
    <body class="skin-black">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $.ajax({
                    url:"<?php echo site_url('admin/contacts/findReplied')?>",
                    type:'POST',
                    data:{},
                    dataType: 'json',
                    success: function(reponse) {
                        var lenght = Object.keys(reponse).length;
                        if(lenght > 0){
                            console.log(Object.keys(reponse).length);
                            console.log(reponse);
                            $("#numNotifi").text(lenght);
                        } else {
                            $("#seeAllcontacts").html('');
                        }
                        $("#blue").text(lenght +' new contacts');
                    },
                    error: function() {
                        alert('aaaaa');
                    }
